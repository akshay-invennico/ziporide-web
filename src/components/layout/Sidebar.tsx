...
const navItems = [
  ...
  { name: "Verification Req", path: "/verification", icon: "/icons/sidebar/sidebarIcon4.svg", badge: "20+" },
  ...
  { name: "Settings", path: "/settings", icon: "/icons/sidebar/sidebarIcon8.svg", hasDropdown: true },
];
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              key={item.name}
              to={item.path}
              className={`flex items-center gap-3 px-3 py-2.5 rounded-md transition-all duration-150 group ${isActive
