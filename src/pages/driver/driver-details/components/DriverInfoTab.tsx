        ...
        <div className="p-5 border border-[#DFE6E5]">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div
                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[13px] font-medium border ${driver.status === 'Active' ? 'bg-[#EAFFF2] text-[#00A63E] border-green-100/50' : 'bg-red-50 text-[#FF0707] border-red-100/50'}`}
              >
                <div
              ...
              {driver.license ? (
                <>
                  <div className="flex items-center justify-between">
                    <span className="text-[13px] text-[#4E616A] font-medium">
                      PAN License Number
                    </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="flex items-center justify-between border border-[#DFE6E5] rounded-lg px-4 py-3">
              ...
              {driver.legalAgreements?.termsOfService ? (
                <span className="text-[12px] font-semibold text-[#00A63E] bg-[#EAFFF2] px-3 py-1 rounded-lg">
                  Agreed
                </span>
              ) : (
                <span className="text-[12px] font-semibold text-[#FF0707] bg-red-50 px-3 py-1 rounded-lg">
                  Not Agreed
                </span>
              )}
            </div>
