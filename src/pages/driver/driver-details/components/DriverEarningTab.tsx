    ...
    if (active && payload && payload.length) {
        return (
            <div className="bg-white border border-[#DFE6E5] rounded-xl shadow-lg px-4 py-3 min-w-[130px]">
                ...
                {label && (
                    <p className="text-[10px] text-[#4E616A] mt-0.5">{label}</p>
                )}
            </div>
        );
    }
...
export default function DriverEarningTab() {
    ...
    const chartData =
        period === 'Year' ? yearlyData :
            period === 'Month' ? monthlyData : weeklyData;
            ...
            <div className="border border-[#DFE6E5] rounded-xl p-5">
                ...
                <div className="flex items-start justify-between mb-5 flex-wrap gap-3">
                    <div>
                        ...
                        <p className="text-[12px] text-[#4E616A] font-medium mt-0.5">Track Driver's Earning amounts</p>
                    </div>
