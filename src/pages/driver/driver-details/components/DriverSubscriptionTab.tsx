        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 justify-between">
          ...
          >
            ...
            >
              ...
              <span
                className="text-white text-[12px] font-semibold px-3 py-1 rounded-full"
              ...
              <tbody>
                {currentData.map((row) => (
                  ...
                  >
                    ...
                    {/* Plan */}
                    <td className="px-4 py-3 text-[13px] font-medium text-[#4E616A]">{row.plan}</td>
                    ...
                    {/* Date */}
                    <td className="px-4 py-3 text-[13px] font-medium text-[#4E616A]">{row.date}</td>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center justify-center bg-[#1A1F71] rounded px-1.5 py-0.5">
                          <span className="text-white font-bold text-[10px] tracking-wider italic">
                            VISA
                          </span>
                        </div>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1.5">
                        ...
                        />
                        <span
                          className={`text-[13px] font-semibold ${row.status === 'Paid' ? 'text-[#00A63E]' : row.status === 'Failed' ? 'text-[#FF0707]' : 'text-yellow-500'}`}
                        >
                          {row.status}
                        </span>
                      </div>
