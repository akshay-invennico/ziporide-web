                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-[#F8F9FA] border-b border-[#DFE6E5] text-[12px] font-medium uppercase tracking-wider text-[#4E616A]">
                                {['TRIP ID', 'RIDER', 'ROUTE', 'AMOUNT', 'DATE', 'RATING', 'STATUS', 'ACTION'].map((col) => (
                                ...
                                <tr key={trip.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td className="px-4 py-3">
                                        <div className="flex items-center gap-2.5">
                                            ...
                                            <div>
                                                <p className="text-[13px] font-medium text-[#101828] leading-tight">{trip.rider.name}</p>
                                    ...
                                    <td className="px-4 py-3">
                                        <div className="flex items-center gap-1.5 text-[13px] font-medium text-[#4E616A]">
                                            ...
                                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#4E616A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    ...
                                    <td className="px-4 py-3">
                                        {trip.rating !== null ? (
                                            <div className="flex items-center gap-1">
                                                ...
                                                <span className="text-[13px] font-medium text-[#4E616A]">{trip.rating.toFixed(1)}</span>
                                            </div>
                                        ) : (
