   ...
   return (
      <>
         <div className="flex flex-col">
            <h3 className="text-[12px] font-medium text-[#4E616A] capitalize mb-3 flex items-center gap-1">Rider Details</h3>
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between mb-10 gap-4">
               <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col justify-center">
                     <h2 className="text-[20px] font-semibold text-[#101828] mb-1">
                        {rider.name}
                     </h2>
            ...
            <div className="pt-2">
               <h4 className="text-[12px] font-medium text-[#4E616A] capitalize mb-6">Saved Addresses</h4>
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="flex items-start gap-3">
                     ...
                     <div>
                        ...
                        <p className="text-[12px] text-[#747C84] leading-relaxed font-medium">{rider.addresses.home}</p>
                     </div>
                  </div>
                  <div className="flex items-start gap-3">
                     <div className="mt-0.5 p-2  flex items-center justify-center  shrink-0">
                     ...
                     <div>
                        ...
                        <p className="text-[12px] text-[#747C84] leading-relaxed font-medium">{rider.addresses.work}</p>
                     </div>
                  </div>
                  <div className="flex items-start gap-3">
                     <div className="mt-0.5 p-2  flex items-center justify-center  shrink-0">
                     ...
                     <div>
                        ...
                        <p className="text-[12px] text-[#747C84] leading-relaxed font-medium">{rider.addresses.other}</p>
                     </div>
                  </div>
               </div>
            </div>
