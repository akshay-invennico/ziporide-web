...
export default function RiderDetailsPage() {
        ...
        return (
            <div className="w-full min-h-screen bg-gray-50/50 p-6 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <button onClick={() => navigate('/rider')} className="text-teal-600 hover:underline">Return to Riders List</button>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="w-full min-h-screen bg-white p-2 ">
            ...
            <div className={`bg-white rounded-lg ${activeTab === 'info' ? 'border border-[#DFE6E5] p-4' : ''}`}>
